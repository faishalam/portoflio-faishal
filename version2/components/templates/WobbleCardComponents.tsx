...
export function WobbleCardComponents() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 max-w-7xl mx-auto w-full">
      <WobbleCard containerClassName="col-span-1 bg-pink-800 min-h-[100px] lg:min-h-[600px] xl:min-h-[300px]">
      ...
      <WobbleCard containerClassName="col-span-1 bg-blue-900 min-h-[100px] lg:min-h-[600px] xl:min-h-[300px]">
        <div className="max-w-full">
